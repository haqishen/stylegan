...
if 1:
    ...
    # Dataset.
    desc += '-faces';     dataset = EasyDict(tfrecord_dir='faces');                 train.mirror_augment = True
    ...
    # 0.6M 1.8M 3.0M 4.2M 5.4M  6.6M 7.8M 9.0M
...
#     desc += '-preset-v2-4gpus'; submit_config.num_gpus = 4; sched.minibatch_base = 16; sched.minibatch_dict = {4: 512, 8: 256, 16: 128, 32: 64, 64: 32, 128: 16, 256: 8}; sched.G_lrate_dict = {256: 0.0015, 512: 0.002, 1024: 0.003}; sched.D_lrate_dict = EasyDict(sched.G_lrate_dict); train.total_kimg = 99000
